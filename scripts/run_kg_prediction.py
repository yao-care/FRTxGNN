...
from frtxgnn.data import load_fda_drugs, filter_active_drugs
from frtxgnn.mapping import (
    map_fda_drugs_to_drugbank,
    map_fda_indications_to_diseases,
    get_mapping_stats,
    get_indication_mapping_stats,
)
from frtxgnn.predict import find_repurposing_candidates, generate_repurposing_report


def main():
    print("=" * 60)
    print("知識圖譜方法 - France藥品老藥新用預測")
    print("Prédiction de Repositionnement de Médicaments en France")
    print("=" * 60)
    print()

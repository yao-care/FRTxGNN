...
BASE_URL = "https://frtxgnn.yao.care"
...
def generate_capability_statement() -> dict:
    ...
    return {
        ...
        "id": "frtxgnn-fhir-server",
        "url": f"{BASE_URL}/fhir/metadata",
        "version": "1.0.0",
        "name": "FRTxGNNFHIRServer",
        "title": "FRTxGNN FHIR Server - France Drug Repurposing",
        "description": "FHIR R4 server for France TxGNN drug repurposing predictions",
        "status": "active",

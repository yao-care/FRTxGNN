...
import pandas as pd
from frtxgnn.collectors import DrugBundleAggregator
from frtxgnn.paths import get_bundles_dir, slugify
...
def preload_predictions(min_score: float = 0.99, top_n: int = 10) -> dict[str, list]:
    ...
    """
    from frtxgnn.collectors.drug_bundle import PredictedIndication
    from frtxgnn.collectors.known_relations import KnownRelationsChecker
...
def patch_single_drug(
    ...
    """
    from frtxgnn.collectors.drug_bundle import DrugBundle
